...
class SplashActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(!hasPermission(this@SplashActivity,*permissionsString)){
            //we will code it latter
            ActivityCompat.requestPermissions(this@SplashActivity,permissionsString,131)

        }else{
            Handler().postDelayed({
                var clickIntent2= Intent(this@SplashActivity, MainActivity::class.java)
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<out String>, grantResults: IntArray) {
        ...
        when(requestCode){
            131->{
                ...
                Toast.makeText(this@SplashActivity,"somnthing went wrong",Toast.LENGTH_SHORT)
                this.finish()
                return
            }
        }
