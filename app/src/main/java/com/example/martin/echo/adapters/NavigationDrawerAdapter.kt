...
import com.example.martin.echo.fragments.AboutUs
import com.example.martin.echo.fragments.Favourite
import com.example.martin.echo.fragments.MainScreen
import com.example.martin.echo.fragments.Settings


/**
 * Created by martin on 1/31/2018.
 */
    ...
    override fun onBindViewHolder(holder: NavViewHolder?, position: Int) {
        ...
        holder?.contentHolder?.setOnClickListener({
            if(position==0){
                ...
                val favouritFragment = Favourite()
                (mContext as MainActivity).supportFragmentManager
                        .beginTransaction()
